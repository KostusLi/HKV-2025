...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(303, "{ КРАХ СОВЕТА }: В Обнародовании (Объявлении) не указан Тип Рода"),
		...
		ERROR_ENTRY(319, "{ КРАХ СОВЕТА }: Превышен максимальный размер Жетона (Токена)"),
		...
		ERROR_ENTRY(615, "{ ПАДЕНИЕ ХРАМА }: Недопустимая Форма в Теле Патруля или Условия"),
