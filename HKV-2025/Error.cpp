...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(205, "{ НЕУДАЧА РАЗВЕДКИ }: Имя Рода (Идентификатор) не должна совпадать с Дворянством (ключевым словом)"),
		...
		ERROR_ENTRY(324, "{ КРАХ СОВЕТА }: Призыв к Служению определен неверно!"),
		ERROR_ENTRY(325, "{ КРАХ СОВЕТА }: Одинаковые значения в 2-х path!"),
