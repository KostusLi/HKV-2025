...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 17,
		...
		Rule(NS('A'), GRB_ERROR_SERIES + 11, 9,					// �������� �������������� ��������
			Rule::Chain(1, TS('+')),
			Rule::Chain(1, TS('-')),
			Rule::Chain(1, TS('*')),
			Rule::Chain(1, TS('/')),
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 14, 18,				// ������������ �������������� �����������
			...
			Rule::Chain(8, TS('q'), TS('('), NS('W'), TS(')'), TS('['), NS('J'), TS(']'), NS('K')), // switch (...) без ;
			Rule::Chain(7, TS('q'), TS('('), NS('W'), TS(')'), TS('['), NS('J'), TS(']')), // switch (...) без ; (конец)
		...
		Rule(NS('J'), GRB_ERROR_SERIES + 16, 4,				// case/default �����
			Rule::Chain(6, TS('v'), NS('V'), TS('['), NS('K'), TS(']'), NS('J')),	// case <lit/id> [K] ...
			Rule::Chain(5, TS('v'), NS('V'), TS('['), NS('K'), TS(']')),			// case <lit/id> [K]
			Rule::Chain(5, TS('d'), TS('['), NS('K'), TS(']'), NS('J')),			// default [K] ...
			Rule::Chain(4, TS('d'), TS('['), NS('K'), TS(']'))					// default [K]
		)
	);
