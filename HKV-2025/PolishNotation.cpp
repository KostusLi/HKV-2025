...
//        case LEX_ALLY: case LEX_BIND: return 4;
//        case LEX_BANISH: return 5;
//        default: return -1;
//        }
//    }
//
...
//        for (int i = 0; i < tbls.lextable.size; i++)
//        {
//            if (tbls.lextable.table[i].lexema == LEX_ASSIGN) // начало выражения������ ���������
//            {
//                begin = i + 1;
//                f_begin = true;
//                continue;
//            }
//            if (f_begin && tbls.lextable.table[i].lexema == LEX_SEMICOLON) // конец выражения����� ���������
//            {
//                end = i;
//                f_end = true;
//                continue;
...
//
//            if (v[i].lexema == LEX_LEFTHESIS || v[i].lexema == LEX_RIGHTTHESIS || v[i].lexema == LEX_PLUS || v[i].lexema == LEX_MINUS || v[i].lexema == LEX_STAR || v[i].lexema == LEX_DIRSLASH || v[i].lexema == LEX_PERSENT || v[i].lexema == LEX_LEFT || v[i].lexema == LEX_RIGHT || v[i].lexema == LEX_ALLY || v[i].lexema == LEX_BIND || v[i].lexema == LEX_BANISH)
//            {
